...
class TestWorkspacePage:
    ...
    def test_workspace_returns_200(self):
        """Should return 200 for any project ID (shell uses dummy data)."""
        response = self.client.get("/projects/1/")
        assert response.status_code == 200

    def test_workspace_contains_project_title(self):
        """Should show the placeholder project title."""
        response = self.client.get("/projects/1/")
    ...
    def test_workspace_contains_three_clip_cards(self):
        """Should render three dummy clip cards."""
        response = self.client.get("/projects/1/")
        content = response.content.decode()
    ...
    def test_workspace_different_project_id_returns_200(self):
        """Should return 200 for any integer project ID."""
        response = self.client.get("/projects/42/")
        assert response.status_code == 200
